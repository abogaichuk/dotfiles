...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "XF86AudioRaiseVolume", function () awful.util.spawn("pactl -- set-sink-volume @DEFAULT_SINK@ +5%") end),
    awful.key({ modkey }, "XF86AudioLowerVolume", function () awful.util.spawn("pactl -- set-sink-volume @DEFAULT_SINK@ -5%") end),
    ...
    awful.key({}, "XF86MonBrightnessUp", function () awful.util.spawn(
        file_exists("/usr/bin/light") and "sudo light -A 10" or "xbacklight +10"
    ) end),
    awful.key({}, "XF86MonBrightnessDown", function () awful.util.spawn(
        file_exists("/usr/bin/light") and "sudo light -U 10" or "xbacklight -10"
    ) end)
)
